...
setup(name='iso2flux',
      ...
      url='',
      scripts=scripts=["create_iso2flux_model.py","get_intervals.py","integrate_gene_expression.py","solve_iso2flux_label.py","p13cmfa.py","create_and_solve_iso2flux_model.py"],
