...
def get_fluxes(label_model,met_con_dict={},split_reactions_dict={},steady_state=True,model=None,precision=10):
    ...
    for reaction_id in label_model.turnover_flux_dict: 
        ...
        net_flux=round(model.solution.x_dict[reaction_id],precision)
        if net_flux>=0:
    ...
    get_f_fluxes(label_model,met_con_dict=met_con_dict,steady_state=steady_state)   
    return label_model.flux_dict  
